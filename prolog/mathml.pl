...
ml(Flags, underbrace(A, Under),
    munder([accentunder(true)], [munder([accentunder(false)], [X, mo([stretchy(true)], &('UnderBrace'))]), Y])) :-
    ml(Flags, A, X),
    ml(Flags, Under, Y).
...
ml(Flags, instead_of(Err, Instead, Of), M) :-
    ...
    M = munder([accentunder(true)], [munder([accentunder(false)], [MInstead, mo([stretchy(true)], &('UnderBrace'))]), MOf]).
...
ml(Flags, instead_of(Err, I, Instead, _Of, Of), M) :-
    ...
    M = munder([accentunder(true)], [munder([accentunder(false)], [MI, mo([stretchy(true)], &('UnderBrace'))]), MOf]).
