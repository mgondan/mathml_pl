...
ml(Flags, instead_of(Err, Instead, Of), M) :-
    ...
    M = munder([accentunder(true)], [munder([accentunder(true)], [MInstead, mo([stretchy(true)], &('UnderBrace'))]), MOf]).
...
ml(Flags, instead_of(Err, I, Instead, _Of, Of), M) :-
    ...
    M = munder([accentunder(true)], [munder([accentunder(true)], [MI, mo([stretchy(true)], &('UnderBrace'))]), MOf]).
