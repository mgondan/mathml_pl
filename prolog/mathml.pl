...
math(Flags, instead_of(Code, uqbinom("lower", "dist", Alpha, N, P), uqbinom("upper", "dist", Alpha, N, P)), 
        Flags, fun(under(instead_of(Code, "argmax", "argmin"), c), instead_of(Code, pbinom(c, N, P), ubinom(c, N, P))) =< Alpha).
